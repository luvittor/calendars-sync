...
// Sets the date and time from which you want to list events
$startDate = '2024-08-24T00:00:00Z'; // Replace with the desired date and time

// Adds the filter to list events from the specified date and time
...
// Displays all events
echo "Total events from $startDate: " . count($allEvents) . "\n";
foreach ($allEvents as $event) {
    echo $event['subject'] . " - Start: " . $event['start']['dateTime'] . "\n";
}
